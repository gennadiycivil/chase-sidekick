#!/usr/bin/env python3
"""Helper script to obtain a Dropbox OAuth2 refresh token.

This script guides you through the OAuth2 authorization code flow to get
a long-lived refresh token for the Dropbox API.
...
def main():
    ...
    print("Refresh tokens don't expire, so you won't need to manually renew.")
    print("\nPrerequisites:")
    print("  1. Dropbox app created at https://www.dropbox.com/developers/apps")
    print("  2. App permissions configured (files.content.read, files.content.write, sharing.read)")
    print("  3. App key and App secret from Settings tab")
    ...
    try:
        ...
        if "refresh_token" not in tokens:
            ...
            print("=" * 80)
            print("\nMake sure token_access_type=offline was set in the auth URL.")
